...
#while time.ctime(time.time()) < TimeToEnd:
    ...
    print(float(InvStatus['Power_Active']))
    ...
    HistoryData = [str(data["F"]), ',', str(data["LP"]), ',', str(data["PPS"]), ',', str(data["id"]), ',', str(data["Cap"]), ',', str(data["PDMax"]), ',', str(data["PCMax"]), ',', str(data["RT"]), ',', str(data["AT"]), ',', str(data["PCon"]), ',',  InvStatus['Power_Active'], ',',  str(data["Pbat"]), ',', str(data["PG"]), ',', str(data["SoC"]), ',', str(data["SoCMin"])]
    i = i + 1
